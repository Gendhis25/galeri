...
// Pastikan user sudah login sebagai user
...
// Periksa apakah pengguna adalah pemilik foto atau admin
if ($_SESSION['user_id'] != $row_foto['UserID'] && $_SESSION['role'] != 'admin') {
    echo "Anda tidak memiliki akses untuk mengedit foto ini.";
    exit();
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt_update->execute()) {
        // Mengalihkan ke view_album.php dengan mengirimkan album_id
...
<body>
    <div class="container">
        ...
        <a href="index.php?id=<?php echo $row_foto['FotoID']; ?>" class="btn">Kembali ke Admin</a>
    </div>
</body>
</html>
